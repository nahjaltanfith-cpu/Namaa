...
export const translations = {
  ...
  hero: {
    title: { ar: "جمعية نماء", en: "Nama Association" },
    subtitle: { ar: "لتنمية القطاع غير الربحي", en: "For Non-Profit Sector Development" },
    description: {
      ar: "نعمل على تنمية القطاع غير الربحي عن طريق ابتكار تدخلات ومشاريع ومنتجات مؤثرة ومستدامة",
      en: "We develop the non-profit sector through innovative, impactful, and sustainable interventions, projects, and products",
    },
  ...
  vision: {
    ...
    text: { ar: "قطاع غير ربحي ممكن ينمو ويزدهر ويحقق أثر.", en: "An empowered non-profit sector that grows, thrives, and creates impact." },
  },
  mission: {
    title: { ar: "رسالتنا", en: "Our Mission" },
    text: {
      ar: "تنمية القطاع غير الربحي عن طريق ابتكار تدخلات ومشاريع ومنتجات مؤثرة ومستدامة.",
      en: "Developing the non-profit sector through innovative, impactful, and sustainable interventions, projects, and products.",
    },
  },
  values: {
  ...
  directions: {
    ...
    items: [
      { ar: "صناعة التدخلات المؤثرة في القطاع غير الربحي", en: "Creating impactful interventions in the non-profit sector" },
      { ar: "توفير الخدمات والمشاريع المبتكرة", en: "Providing innovative services and projects" },
      { ar: "السعي لتكامل العمل في القطاع غير الربحي", en: "Pursuing integration in the non-profit sector" },
      { ar: "دعم صعود الكيانات في القطاع غير الربحي", en: "Supporting the rise of non-profit entities" },
      { ar: "الاهتمام بتنمية موارد القطاع غير الربحي", en: "Developing non-profit sector resources" },
    ],
  },
  workAreas: {
  ...
  impact: {
    ...
    items: [
      ...
      { value: 50, label: { ar: "شراكة معقودة", en: "Partnerships" } },
      { value: 4, label: { ar: "كيانات غير ربحية مدعومة", en: "Supported Entities" } },
      { value: 1000, label: { ar: "عامل مدرب في القطاع", en: "Trained Workers" } },
    ],
  },
  projects: {
  ...
  associationGoals: {
    ...
    intro: {
      ar: "تهدف الجمعية إلى تحقيق الغرض الذي أنشئت من أجله، وذلك إلى تحقيق الأهداف التالية:",
      en: "The association aims to achieve the purpose for which it was established, by fulfilling the following goals:",
    },
    items: [
      { ar: "نشر وتعزيز ثقافة العمل المؤسسي في أوساط القطاع غير الربحي", en: "Spreading and promoting institutional work culture in the non-profit sector" },
      { ar: "نشر ثقافة العمل التنموي في المجال الخيري", en: "Promoting developmental work culture in the charitable field" },
      { ar: "المشاركة في التنمية المجتمعية في القطاع غير الربحي", en: "Participating in community development in the non-profit sector" },
      { ar: "المساهمة في تطوير المؤسسات الأهلية والارتقاء بها", en: "Contributing to developing and advancing civil institutions" },
      { ar: "المساهمة في تأهيل العاملين في القطاع غير الربحي وتطوير قدراتهم", en: "Contributing to qualifying non-profit sector workers and developing their capabilities" },
      { ar: "المساهمة في بناء القدرات المؤسسية والبشرية وتطويرها في القطاع غير الربحي", en: "Contributing to building and developing institutional and human capacities in the non-profit sector" },
      { ar: "دعم الأبحاث والدراسات في العمل الخيري", en: "Supporting research and studies in charitable work" },
      { ar: "تقديم مبادرات لطرح حلول للمشكلات التي تواجه منظمات القطاع غير الربحي", en: "Presenting initiatives to solve problems facing non-profit organizations" },
      { ar: "تقديم الاستشارات لتطوير العمل التنموي في المجال الخيري", en: "Providing consultations to develop developmental work in the charitable field" },
      { ar: "تقديم الدعم الإداري والفني لمنظمات القطاع غير الربحي", en: "Providing administrative and technical support to non-profit organizations" },
      { ar: "تطوير المهارات للعاملين في المشروعات التنموية", en: "Developing skills for workers in developmental projects" },
      { ar: "تثقيف العاملين في القطاع غير الربحي", en: "Educating non-profit sector workers" },
      { ar: "تأهيل منسوبي القطاع غير الربحي", en: "Qualifying non-profit sector personnel" },
    ],
  },
  boardOfDirectors: {
    title: { ar: "مجلس الإدارة", en: "Board of Directors" },
    members: [
      { name: { ar: "مشبب مسفر مشبب الأحمري", en: "Meshbeb Misfer Meshbeb Al-Ahmari" }, role: { ar: "رئيس مجلس الإدارة", en: "Chairman of the Board" }, title: { ar: "", en: "" } },
      { name: { ar: "حسين مسعود سعيد القحطاني", en: "Hussain Masoud Saeed Al-Qahtani" }, role: { ar: "نائب رئيس مجلس الإدارة", en: "Vice Chairman" }, title: { ar: "مهندس", en: "Eng." } },
      { name: { ar: "عبدالله خالد علي آل عبود", en: "Abdullah Khaled Ali Al Aboud" }, role: { ar: "عضو مجلس إدارة", en: "Board Member" }, title: { ar: "", en: "" } },
      { name: { ar: "سعيد ظافر سعيد الأحمري", en: "Saeed Dhafer Saeed Al-Ahmari" }, role: { ar: "عضو مجلس إدارة", en: "Board Member" }, title: { ar: "مهندس", en: "Eng." } },
      { name: { ar: "سعيد محمد مفرح الشريف", en: "Saeed Mohammed Mufreh Al-Sharif" }, role: { ar: "عضو مجلس إدارة", en: "Board Member" }, title: { ar: "الأستاذ", en: "Mr." } },
    ],
  },
  associationMembers: {
    title: { ar: "أعضاء الجمعية", en: "Association Members" },
    members: [
      { ar: "مشبب مسفر مشبب الأحمري", en: "Meshbeb Misfer Meshbeb Al-Ahmari" },
      { ar: "عبدالله خالد علي آل عبود", en: "Abdullah Khaled Ali Al Aboud" },
      { ar: "سعيد ضيف الله محمد القرني", en: "Saeed Dhaifallah Mohammed Al-Qarni" },
      { ar: "سعيد ظافر سعيد الأحمري", en: "Saeed Dhafer Saeed Al-Ahmari" },
      { ar: "معجل فرحان لاحق عسيري", en: "Moajjal Farhan Laheq Asiri" },
      { ar: "حسن مرعي حسن أبو خلوه", en: "Hassan Marei Hassan Abu Khalwah" },
      { ar: "محمد مصلح سعد الشمراني", en: "Mohammed Musleh Saad Al-Shamrani" },
      { ar: "سعيد محمد مفرح الشريف", en: "Saeed Mohammed Mufreh Al-Sharif" },
      { ar: "حسين مسعود سعيد القحطاني", en: "Hussain Masoud Saeed Al-Qahtani" },
      { ar: "محمد عائض محمد القرني", en: "Mohammed Ayedh Mohammed Al-Qarni" },
      { ar: "عبدالله سعيد عايض الشهراني", en: "Abdullah Saeed Ayedh Al-Shahrani" },
      { ar: "فلاح فالح مهدي الشهراني", en: "Falah Faleh Mahdi Al-Shahrani" },
    ],
  },
  associationInfo: {
    title: { ar: "بيانات الجمعية", en: "Association Information" },
    name: { ar: "نماء لتطوير القطاع غير الربحي", en: "Nama for Non-Profit Sector Development" },
    location: { ar: "أبها", en: "Abha" },
    scope: { ar: "حسب ما تحدده اللائحة الأساسية", en: "As determined by the bylaws" },
    certificate: {
      ar: "صدرت هذه الشهادة بموجب القرار 1000567200 وتاريخ 1445/07/16 هـ بناءً على نظام الجمعيات والمؤسسات الأهلية الصادر بالمرسوم الملكي رقم م/٨ وتاريخ ١٩/٢/١٤٣٧ هـ",
      en: "This certificate was issued pursuant to Resolution 1000567200 dated 1445/07/16 H, based on the Associations and Civil Institutions Law issued by Royal Decree No. M/8 dated 19/2/1437 H",
    },
  },
  board: {
  ...
  footer: {
    description: {
      ar: "جمعية نماء لتنمية القطاع غير الربحي - نعمل على تنمية القطاع غير الربحي عبر الابتكار والاستدامة",
      en: "Nama Association for Non-Profit Sector Development - Developing the non-profit sector through innovation and sustainability",
    },
    quickLinks: { ar: "روابط سريعة", en: "Quick Links" },
    contactInfo: { ar: "معلومات التواصل", en: "Contact Info" },
    email: { ar: "info@nama.org.sa", en: "info@nama.org.sa" },
    phone: { ar: "+966 XX XXX XXXX", en: "+966 XX XXX XXXX" },
